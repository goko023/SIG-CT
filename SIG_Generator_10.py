...
class App(ctk.CTk):
    ...
    def _build_header(self):
        ...
        neon = make_neon_label(hdr, "SIG Generator", font_size=16, bg="#111111")
    ...
    def _build_welcome(self):
        ...
        neon2 = make_neon_label(right, "SIG Generator", font_size=24, bg="#0a0a0a")
        neon2.pack(anchor="w")
        ...
        ctk.CTkLabel(right, text="v5.0  --  SimpleItemGenerator Config Tool",
                     font=("Consolas", 10),
